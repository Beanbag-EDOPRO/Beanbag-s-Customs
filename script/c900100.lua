...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(id,ACTIVITY_SUMMON,function(c) return c:IsSetCard(0x385) end)
	Duel.AddCustomActivityCounter(id,ACTIVITY_SPSUMMON,function(c) return c:IsAttribute(0x385) end)
